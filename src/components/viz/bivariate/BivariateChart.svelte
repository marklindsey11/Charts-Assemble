...
<div>
    <div
        class="w-full bg-gray-100 pb-1 pt-1"
            ...
            <div class="rounded border border-solid variable pl-1 pr-1">
                ...
                {#if TIMESTAMPS.has(xType)}
                    <span class="timestep-select">
                        ...
                        {#if showTimeStepMenu}
                            <div
                                class="absolute right-1 mt-2 w-20 origin-top-right rounded-md bg-white hover:bg-gray-100 dark:bg-zinc-900 shadow-lg border border-gray-50 dark:border-gray-800 ring-1 ring-black ring-opacity-5 focus:outline-none transform scale-100"
